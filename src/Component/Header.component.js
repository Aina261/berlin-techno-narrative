...
export const Header = () => {
    ...
    const _scrollDown = () => window.scrollTo({top: window.innerHeight, behavior: 'smooth'});
    ...
    return (
        ...
        >
            ...
            <div className={"absolute bottom-0 transform rotate-90 m-2 z-50"} onClick={_scrollDown}>
